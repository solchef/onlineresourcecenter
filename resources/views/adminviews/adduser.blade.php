        ...
        <div class="col-lg-7 "  style="left: 200px;" >
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>New User(Instructors) <small>Capture a new user details to add him/her to the system</small></h5>
             ...
             <form role="form" method="post" action="{{ url('createuser') }}">
                {{ csrf_field() }}
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Mobile numbers" required>
                           ...
                           <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    <label for="exampleInputEmail1">Faculty Enrolled</label>
                  ...
                  <div class="form-group">
                        <label for="exampleInputEmail1">Select the Lecturer Courses</label>
                        <select data-placeholder="Choose a course..." class="chosen-select" name="courses[]" multiple style="width:350px;" tabindex="4">
