         ...
         <div class="ibox-content">
            <div class="row">
                            ...
                            <div class="file-manager">
                               ...
                               <h4>Unit Folders<small>(click on a folder to view its files)</small></h4>
                                ...
                                <ul class="folder-list" style="padding: 0">
                                    ...
                                    <li><a href=""><i class="fa fa-folder"></i> {{$unit->unit_name}}</a></li>
                                    @endforeach
                                </ul>
                ...
                <div class="col-lg-8 animated fadeInRight">
                    <div class="row">
                        <div class="col-lg-12">
                     @foreach($papers as $past)
                            <div class="file-box">
                                <div class="file">
                                  
                                     <a href="{{ asset('pastpapers') }}/{{$past->paperfile}}" download>
                                        ...
                                        <div class="file-name">
                                            {{$past->pastpapername}}
                                            <br/>
                                            <small>Added: {{$past->created_at}}</small>
                                        </div>
                                    </a>
