...
<div class="wrapper wrapper-content">
        ...
        <div class="ibox-title">
            <h5>Upload Video Lectures</h5>
        </div>
        <div class="ibox-content">
            <form role="form" method="post" action="{{ url('uploadvideos') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                
                    <div class="form-group">
                        <label for="exampleInputEmail1">Video Name</label>
                         <input type="text" name="videoname" class="form-control" id="message" placeholder="Type video name" required>
                       
                    </div>

                       <div class="form-group">
                        <label for="exampleInputEmail1">Video Name</label>
                         <textarea  name="details" class="form-control" id="details" rows="3"  placeholder="video description" required></textarea>
                 ...
                 <div class="form-group">
                  ...
                  <button class="file-upload-btn" type="button" onclick="$('.file-upload-input').trigger( 'click' )">Add Video Lecture</button>

                  <div class="image-upload-wrap">
                    <input class="file-upload-input" name="paperupload" type='file' multiple onchange="readURL(this);" accept="video/mp4,video/x-m4v,video/*"/ required>
                    <div class="drag-text">
