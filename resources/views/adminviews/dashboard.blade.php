...
<div class="wrapper wrapper-content">
            <div class="row">
                      ...
                      <a href="{{url('viewassignments')}}">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right">@lang('Submitted')</span>
                                <h5>@lang('messages.Assignments')</h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-success">@lang('Assignments')</div>
                    ...
                    <div class="col-lg-3">
                      <a href="{{url('viewcoursescert')}}">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-primary pull-right">@lang('Ongoing')</span>
                                <h5>@lang('Courses')</h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-navy">{{$courses}}</div>
                                <small>@lang('Active Courses')</small>
                            </div>
                        </div>
                      </a>
                    </div>
                    <div class="col-lg-3">
                      <a href="{{url('viewpayments')}}">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-danger pull-right">@lang('Paid')</span>
                                <h5>@lang('Fees')</h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-danger">KSH {{ $totalpaid }}</div>
                                <small>@lang('Total Paid')</small>
                            </div>
                        </div>
                      </a>
