...
<div class="wrapper wrapper-content">
         <div class="row"">
                      ...
                      <a href="{{url('studentnotes')}}">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <h5><i class="fa fa-book"></i> @lang('Notes')</h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-info">{{ $notes[0]->notes }}</div>
                                <small> @lang('Notes Uploaded')</small>
                            </div>
                        </div>
                      </a>
                    </div>
                    <div class="col-lg-3">
                      <a href="{{url('viewassignments')}}">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <!-- <span class="label label-danger pull-right">{{ $assignments[0]->assignments - $sub[0]->counter}} Pending</span> -->
                                <h5> <i class="fa fa-quora"></i> @lang('Assignments')</h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-navy">{{ $assignments[0]->assignments }}</div>
                                <small>@lang('Total assignments')</small>
                            </div>
                        </div>
                      </a>
                    </div>
                    <div class="col-lg-3">
                      <a href="{{url ('studentstatement')}}/{{ Auth::user()->id }}">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-danger pull-right"></span>
                                <h5><i class="fa fa-briefcase"></i> @lang('Fees')</h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>  
                                <div class="stat-percent font-bold text-danger"> {{$feebal}} </div>
                                <small>@lang('Current Balance')</small>
                            </div>
                        </div>
                      </a>
            </div>
        ...
        <div class="row">
                    <div class="col-lg-4">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                               <h3><strong><u><i class="fa fa-list"></i> @lang('My Course')</u></strong></h3>
                                
                           
                            </div>
                            <div class="ibox-content">
                                <div class="row">
                          <h5>@lang('Welcome') {{ Auth::user()->name }}</h5>
           ...
           <div id="myTabContent" class="tab-content">
               <ol class="nav nav-pills nav-stacked main-menu">
                            ...
                            <a href="{{url('studentnotes')}}"><i class=""></i><span style="color: #3c763d">  <b> {{ $cou->course_code }} - {{ $cou->course_name }} </b></span></a>
                            <ul class="nav nav-pills nav-stacked">
                               
                   <H5><u>@lang('OVERVIEW')</u></H5>
                      <li>{{$cou->description}}</li>
                    ...
                    <div class="col-lg-4">
                            ...
                            <div class="ibox-title">
                                  ...
                                  <h3><strong><u><i class="fa fa-clock-o"></i> @lang('My Schedules')</u></strong></h3>
                                </div>
                                  <div class="ibox-content">
                                <div class="row">
                                  <table class="table">
                    ...
                    <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                      <i class="fa fa-users"></i>  @lang('Members') ({{$memcount}})   <span class="label label-success" id="notcount"></span>
                    </a>
                    <ul class="dropdown-menu " style="list-style-type: disc; list-style-position: inside;">
                      ...
                      @endforeach
                            ...
                            <div class="ibox-title">
                               <h3><strong><u><i class="fa fa-weixin"></i> @lang('Study Group Chat') </u><br> </strong>({{ $chatscount}} Messages)</h3>
                            ...
                            <div class="ibox-content">
                               ...
                               <div style="" class=" alert alert-success col-md-9">
                                 <p>@lang('Hey there, It seems there is no conversation in your group. Start a conversation to for your group members to join.') <br>
                                    <span style="color: grey;">@lang('Today') - Online Resource Center</span></p>
                            ...
                            <div style="" class="pull-right alert alert-warning col-md-8 col-md-offset-1">
                                 <p>{{$chat->message}} <br>
                                    <span style="color: grey;">{{$chat->created_at}} - {{ $chat->name }}</span></p>
                             ...
                             @endforeach 
                                ...
                                <form method="post" action="{{url('groupchat') }}">
                                  {{ csrf_field() }}
                                <div class="form-group">
                                  <label>@lang('Type Message')</label>
                                <textarea class="form-control" name="message" autofocus placeholder="Type Message">
                                    
                                  </textarea>
                                </div>
                                  <br>
                                <a href="{{url('home')}}" class="btn btn-success btn-sm">@lang('Refresh')</a>
                                 <button type="submit" href="#" class="btn btn-primary btn-sm pull-right">@lang('Send Message')</button>
                               </form>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div  class="modal-body">
                ...
                <div class="form-group form-inline">
                    <div class="input-group date" data-provide="datepicker">
                       ...
                       @lang('Schedule Start Date'): <input type="text"  name="enddate" class="form-control" id="apptStartTime" placeholder="Due">
                ...
                <div class="form-group form-inline">
                    <div class="input-group date" data-provide="datepicker">
                       ...
                       @lang('Schedule End Date'): <input type="date"  name="enddate" class="form-control" id="apptEndTime" placeholder="Due Date mm/dd/yyyy">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="submitButton">@lang('Save')</button>
            </div>
        </div>
    </div>
</div>
