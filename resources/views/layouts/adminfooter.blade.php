...
<!-- Mainly scripts -->
    ...
    <script src="{{ asset('spiniastuff/js/jquery-3.1.1.min.js') }}"></script>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="frmTasks" name="frmTasks" class="form-horizontal" novalidate="">
                                <div class="form-group error">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control has-error "  id="task_id" name="task" placeholder="Task" value="Sparaying">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control " id="job_type" name="description" placeholder="Description" value="">
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control " id="clientname" name="description" placeholder="Description" value="">
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success btn-large" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">Close</span></button>
