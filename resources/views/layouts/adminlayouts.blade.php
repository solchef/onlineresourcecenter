...
<head>
    ...
    <link href="{{ asset('spiniastuff/css/plugins/bootstrap-chosen.css') }}" rel="stylesheet">
            ...
            <div class="sidebar-collapse ">
                @if (Auth::check())
                    <ul class="nav metismenu " id="side-menu">
                        <li class="nav-header" style="">
                            <div class="dropdown profile-element"
                                style="display:flex; flex-direction:column;align-items:center;"> <span>
                                    @if (empty(Auth::user()->avatar))
                                        <img alt="image" height="80" width="80" class="img-circle"
                                            src="{{ asset('spiniastuff/img/profile_big.jpg') }}" />
                                    @else
                                        <img alt="image" height="80" width="80" class="img-circle"
                                ...
                                {{-- <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                    <span class=""> <span class="block m-t-xs"> <strong
                                                class="font-bold"></strong>
                                        </span> <span class="text-muted text-xs block"><b class="caret ">
                                                <h3>{{ Auth::user()->name }}</h3>
                                            </b></span> </span> </a> --}}
                                @php($id = Auth::user()->id)
                        ...
                        @if (Auth::user()->roleid == 1 or Auth::user()->roleid == 2 or Auth::user()->roleid == 3 or Auth::user()->roleid == 5)
                            ...
                            <li class="active">
                                <a href="{{ url('home') }}"><i class="fa fa-institution (alias)"></i> <span
                                        class="nav-label">@lang('Dashboard')</span> </a>
                            </li>
                            ...
                            @if (Auth::user()->roleid == 2)
                                <li>
                                    <a href="#"><i class="fa fa-eye"></i> <span
                                            class="nav-label">@lang('Courses')</span><span class="fa arrow"></span></a>
                                    <ul class="nav nav-second-level collapse">
                            ...
                            @if (Auth::user()->roleid == 3)
                                <li>
                                    <a href="#"><i class="fa fa-book"></i> <span
                                            class="nav-label">@lang('My Course')</span><span
                            ...
                            @if (Auth::user()->roleid == 1 or Auth::user()->roleid == 5)
                                <li>
                                    <a href="#"><i class="fa fa-quora"></i> <span
                                            class="nav-label">@lang('Assignments')</span><span
                                            class="fa arrow"></span></a>
                                    <ul class="nav nav-second-level collapse">
                            ...
                            <li>
                                <a href="#"><i class="fa fa-space-shuttle"></i> <span
                                        class="nav-label">@lang('Library References')</span><span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level collapse">
                            ...
                            @if (Auth::user()->roleid == 1 or Auth::user()->roleid == 2 or Auth::user()->roleid == 5)
                                <li>
                                    <a href="#"><i class="fa fa-graduation-cap"></i> <span
                                            class="nav-label">@lang('Manage Users')</span><span
                                            class="fa arrow"></span></a>
                                    <ul class="nav nav-second-level collapse">
                            ...
                            @if (Auth::user()->roleid == 1 or Auth::user()->roleid == 3)
                                <li>
                                    <a href="#"><i class="fa fa-print"></i> <span
                                            class="nav-label">@lang('Financials')</span><span
                                            class="fa arrow"></span></a>
                                    <ul class="nav nav-second-level collapse">
                                        @if (Auth::user()->roleid == 1)
                                        ...
                                        @if (Auth::user()->roleid == 3)
                                            <li><a
                                                    href="{{ url('studentstatement') }}/{{ Auth::user()->id }}">@lang('View Fee Statement')</a>
                                            </li>
                                        @endif
                                    </ul>
                                </li>
                            ...
                            @if (Auth::user()->roleid == 1 or Auth::user()->roleid == 5)
                                <li>
                                    ...
                                    <a href="#"><i class="fa fa-cog"></i> <span
                                            class="nav-label">@lang('Settings') </span><span
                                            class="fa arrow"></span></a>
                                    <ul class="nav nav-second-level collapse">
                            ...
                            @if (Auth::user()->roleid == 3 or Auth::user()->roleid == 2 or Auth::user()->roleid == 1)
                                <li>
                                    <a href="{{ url('updateprofile') }}/{{ Auth::user()->id }}"><i
                                            class="fa fa-user"></i> <span
                                            class="nav-label">@lang('My profile')</span></a>
                                </li>
                            @endif
                            @if (Auth::user()->roleid == 3)
                                <li>
                        ...
                        @if (Auth::user()->roleid == 4 or Auth::user()->roleid == 5)
                            ...
                            <li>
                                <a href="{{ url('studentfees') }}"><i class="fa fa-pencil"></i> <span
                    ...
                    <a href="{{ url('feestructure') }}"><i class="fa fa-book"></i> <span class="nav-label">Fees Structure</span></a>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level collapse">
                                    <li>
                                        <a href="{{ url('viewpayments') }}"><i class="fa fa-eye"></i> <span
                                                class="nav-label">View Payments</span></a>

                                    </li>

                                    <li>
                                        <a href="{{ url('viewbalances') }}"><i class="fa fa-book"></i> <span
                            ...
                            <li>
                                <a href="{{ url('studentstatements') }}"><i class="fa fa-list"></i> <span
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level collapse">
                                    <li>
                                        <a href="{{ url('campuspayments') }}"><i class="fa fa-book"></i> <span
                                                class="nav-label">Payments By Campus</span></a>

                                    </li>

                                    <li>
                                        <a href="{{ url('facultypayments') }}"><i class="fa fa-book"></i> <span
                ...
                <li>
                    <a href="{{ url('allpayments') }}"><i class="fa fa-book"></i> <span class="nav-label">All Payments</span></a>
                            ...
                            <li>
                                <a href="{{ url('resetpassadmin') }}"><i class="fa fa-cog"></i> <span
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top  " role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-left">
                        ...
                        <li><a href="{{ url('/') }}" data-toggle="tooltip" data-placement="bottom"
                    ...
                    @if (Auth::check())
                        <ul class="nav navbar-top-links navbar-right">
                            ...
                            @if (Auth::user()->roleid == 1 or Auth::user()->roleid == 2)
                                <li>
                                    <a href="{{ url('viewtickets') }}">
                                        <span class="m-r-sm text-muted welcome-message text-white">@lang('View Enquiries')
                            ...
                            @else
                                <li>
                                    <a href="{{ url('support') }}">
                                        <span class="m-r-sm text-muted welcome-message text-white">@lang('Enquiry Desk')
                                            <i class="fa fa-headphones"></i></span>
                                    </a>
                                </li>
                            @endif
                            ...
                            <li class="dropdown">
                                <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                                    @lang('Notifications') <i class="fa fa-bell"></i> <span class="label label-warning"
                                        id="notcount"></span>
                                </a>
                            ...
                            <li>
                                <span class="m-r-sm text-muted welcome-message text-white">@lang('Welcome'):
                                    {{ Auth::user()->name }}</span>
                            </li>
