    ...
    <br><br><br><br><br><br>
       ...
       <div class="wrapper wrapper-content" >
        <div class="middle-box text-center animated fadeInRightBig" style="background-color:white;">
            <h3 class="font-bold">Sorry Your Account has been Suspended</h3>
            <div class="error-desc">
               Please contact the Admin at info@onlineresourcecenter.nl for furter details and to restore your account.
                <br>
                 <a href="{{ route('logout') }}" class="btn btn-success" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
