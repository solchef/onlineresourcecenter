...
<?php $__env->startSection('content'); ?>
                ...
                <div class="row">
                        ...
                        <div class="ibox-content">
                                ...
                                <div class="row">
                <div class="" s">
                <form action="<?php echo e(url('createreference')); ?>" method="post" role="form" id="formation" style="margin-top:0px;" enctype="multipart/form-data">
                       <?php echo e(csrf_field()); ?>

                <div class="panel-heading">
                <h2 class="text-warning text-center">Create Library References <hr class="colorgraph"></h2>
                </div>
                <div class="form-group col-md-6">
                <label>REFERENCE NAME</label>
                <input type="text" name="reference_name" class="form-control" placeholder="Reference Name" required>
                </div>
                <!-- <div class="form-group col-md-6"> -->
       <!--          <label>TARGET GROUP</label>
                        <select class="form-control" name="targetcourse">
                ...
                <option value="4">Past Project Papers</option>
                </select>
                </div>
                <div class="form-group col-md-6">
                <label>Target Groups</label>
                 <select data-placeholder="Choose a courses..." class="chosen-select" name="targetcourse[]" multiple style="width:350px;" tabindex="4">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="file" name="referencefile" class="form-control">
                </div>
