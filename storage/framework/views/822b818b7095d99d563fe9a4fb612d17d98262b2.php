     ...
     <div class="col-lg-12">
        ...
        <div class="ibox-content">
             <table class="table table-responsive table-stripped table-bordered">
                 ...
                 <?php endif; ?>
                  <?php if(Auth::user()->roleid == 1 || Auth::user()->roleid == 5): ?>
                 <th>Edit</th>
                 <th>Delete</th>
                 <?php endif; ?>
...
<?php echo $__env->make('layouts.adminlayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineresource\resources\views/adminviews/viewcourses.blade.php ENDPATH**/ ?>