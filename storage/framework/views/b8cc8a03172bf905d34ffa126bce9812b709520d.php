...
<div class="wrapper wrapper-content">
            <div class="row">
                    ...
                    <div class="col-lg-3">
                      <a href="<?php echo e(url('viewpayments')); ?>">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-success">USD <?php echo e($totalpaid); ?></div>
                    ...
                    <div class="col-lg-3">
                      <a href="<?php echo e(url('viewbalances')); ?>">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-success">USD <?php echo e($balance); ?></div>
                    ...
                    <div class="col-lg-3">
                      <a href="<?php echo e(url('viewbalances')); ?>">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-success"> <?php echo e($arr); ?></div>
