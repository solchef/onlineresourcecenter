...
<div class="wrapper wrapper-content">
                      ...
                      <a href="<?php echo e(url('viewassignments')); ?>">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><?php echo app('translator')->get('Submitted'); ?></span>
                                <h5><?php echo app('translator')->get('messages.Assignments'); ?></h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-success"><?php echo app('translator')->get('Assignments'); ?></div>
                                <small><?php echo app('translator')->get('Total Assignments'); ?></small>
                            </div>
                        </div>
                      </a>
                    </div>
                    <div class="col-lg-3">
                      <a href="<?php echo e(url('manageusers')); ?>">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-info pull-right"><?php echo app('translator')->get('Registered'); ?></span>
                                <h5><?php echo app('translator')->get('Students'); ?></h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-inf"><?php echo e($students[0]->students); ?></div>
                                <small><?php echo app('translator')->get('Registered Students'); ?></small>
                            </div>
                        </div>
                      </a>
                    </div>
                    <div class="col-lg-3">
                      <a href="<?php echo e(url('viewcoursescert')); ?>">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-primary pull-right"><?php echo app('translator')->get('Ongoing'); ?></span>
                                <h5><?php echo app('translator')->get('Courses'); ?></h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-navy"><?php echo e($courses); ?></div>
                                <small><?php echo app('translator')->get('Active Courses'); ?></small>
                            </div>
                        </div>
                      </a>
                    </div>
                    <div class="col-lg-3">
                      <a href="<?php echo e(url('viewpayments')); ?>">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-danger pull-right"><?php echo app('translator')->get('Paid'); ?></span>
                                <h5><?php echo app('translator')->get('Fees'); ?></h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-danger">KSH <?php echo e($totalpaid); ?></div>
                                <small><?php echo app('translator')->get('Total Paid'); ?></small>
                            </div>
                        </div>
                      </a>
        ...
        <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5><?php echo app('translator')->get('Student Distribution Chart'); ?></h5>
                                <div class="pull-right">
                                    <div class="btn-group">
                                        <b><?php echo app('translator')->get('Calender Schedule'); ?></b>
                                    </div>
                                </div>
                            </div>
                            <div class="ibox-content">
                                ...
                                <div class="col-lg-4">
                                  <h3><strong><u><?php echo app('translator')->get('Upcoming Event Schedules'); ?></u></strong></h3>
                                  <hr>
...
<?php echo $__env->make('layouts.adminlayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onlineresource\resources\views/adminviews/dashboard.blade.php ENDPATH**/ ?>