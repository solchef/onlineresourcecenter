...
<div class="wrapper wrapper-content">
        ...
        <div class="ibox-title">
            <h5><?php echo app('translator')->getFromJson('Add a New Course'); ?></h5>
        </div>
 ...
 <form role="form" method="post" action="createcourse" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>
                 ...
                 <div class="form-group">
                        ...
                        <?php $__currentLoopData = $campus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cmp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($cmp->id); ?>"><?php echo e($cmp->campusname); ?></option>
                ...
                <input type="hidden" name="status" value="1">
                    ...
                    <button type="Add" class="btn btn-default">Submit</button>
                        ...
                        <div class="modal inmodal" id="managecategory" tabindex="-1" style="margin-top: 50px;" role="dialog"  aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated fadeIn">

                           <form action="<?php echo e(url('updatecategory')); ?>" method="post">
                                                <?php echo e(csrf_field()); ?>
