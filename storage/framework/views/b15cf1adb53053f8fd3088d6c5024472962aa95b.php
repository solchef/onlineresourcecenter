...
<div class="wrapper wrapper-content">
            <div class="row">
                      ...
                      <a href="<?php echo e(url('viewassignments')); ?>">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><?php echo app('translator')->getFromJson('Submitted'); ?></span>
                                <h5><?php echo app('translator')->getFromJson('messages.Assignments'); ?></h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-success"><?php echo app('translator')->getFromJson('Assignments'); ?></div>
                    ...
                    <div class="col-lg-3">
                      <a href="<?php echo e(url('manageusers')); ?>">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-info pull-right"><?php echo app('translator')->getFromJson('Registered'); ?></span>
                                <h5><?php echo app('translator')->getFromJson('Students'); ?></h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-inf"><?php echo e($students[0]->students); ?></div>
                                <small><?php echo app('translator')->getFromJson('Registered Students'); ?></small>
                            </div>
                        </div>
                      </a>
                    </div>
                    <div class="col-lg-3">
                      <a href="<?php echo e(url('viewcoursescert')); ?>">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-primary pull-right"><?php echo app('translator')->getFromJson('Ongoing'); ?></span>
                                <h5><?php echo app('translator')->getFromJson('Courses'); ?></h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-navy"><?php echo e($courses); ?></div>
                                <small><?php echo app('translator')->getFromJson('Active Courses'); ?></small>
                            </div>
                        </div>
                      </a>
                    </div>
                    <div class="col-lg-3">
                      <a href="<?php echo e(url('viewpayments')); ?>">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-danger pull-right"><?php echo app('translator')->getFromJson('Paid'); ?></span>
                                <h5><?php echo app('translator')->getFromJson('Fees'); ?></h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-danger">KSH <?php echo e($totalpaid); ?></div>
                                <small><?php echo app('translator')->getFromJson('Total Paid'); ?></small>
                            </div>
                        </div>
                      </a>
        ...
        <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5><?php echo app('translator')->getFromJson('Student Distribution Chart'); ?></h5>
                                <div class="pull-right">
                                    <div class="btn-group">
                                        <b><?php echo app('translator')->getFromJson('Calender Schedule'); ?></b>
                                    </div>
                                </div>
                            </div>
                            <div class="ibox-content">
                                ...
                                <div class="col-lg-4">
                                  <h3><strong><u><?php echo app('translator')->getFromJson('Upcoming Event Schedules'); ?></u></strong></h3>
                                  <hr>
