...
<div class="wrapper wrapper-content">
            <div class="row">
                   <div class="col-lg-3">
                      <a href="<?php echo e(url('viewassignments')); ?>">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="stat-percent font-bold text-success"><?php echo e($assignments[0]->assignments); ?> <i class="fa fa-b"></i></div>
                    ...
                    <div class="col-lg-3">
                      <a href="<?php echo e(url('manageusers')); ?>">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins"></h1>
                                <div class="stat-percent font-bold text-inf"><?php echo e($students[0]->students); ?> <i class="fa fa-level-up"></i></div>
                    ...
                    <div class="col-lg-3">
                      <a href="<?php echo e(url('viewcourses')); ?>">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                    ...
                    <div class="col-lg-3">
                      <a href="<?php echo e(url('chatview')); ?>">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
