        ...
        <?php if(Auth::check()): ?>
            ...
            <div class="logo-element">
             ...
             <?php if(Auth::user()->roleid == 1 OR Auth::user()->roleid == 2 OR Auth::user()->roleid == 3 OR Auth::user()->roleid == 5): ?>
                ...
                <li class="active">
                    <a href="<?php echo e(url('home')); ?>"><i class="fa fa-institution (alias)"></i> <span class="nav-label"><?php echo app('translator')->get('Dashboard'); ?></span> </a>
                </li>
              ...
              <?php if(Auth::user()->roleid == 5): ?>
                ...
                <li>
                    <a href="#"><i class="fa fa-eye"></i> <span class="nav-label"><?php echo app('translator')->get('Courses'); ?></span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <?php if(Auth::user()->roleid == 3): ?>
                 <li>
                    <a href="#"><i class="fa fa-book"></i> <span class="nav-label"><?php echo app('translator')->get('My Course'); ?></span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <?php endif; ?>
                 ...
                 <li>
                    <a href="#"><i class="fa fa-quora"></i> <span class="nav-label"><?php echo app('translator')->get('Assignments'); ?></span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
              ...
              <li>
                    <a href="#"><i class="fa fa-space-shuttle"></i> <span class="nav-label"><?php echo app('translator')->get('Library References'); ?></span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <?php if(Auth::user()->roleid == 1 OR Auth::user()->roleid == 2 OR Auth::user()->roleid == 5): ?>
               <li>
                    <a href="#"><i class="fa fa-graduation-cap"></i> <span class="nav-label"><?php echo app('translator')->get('Manage Users'); ?></span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                      
                        <!-- <li><a href="<?php echo e(url('searchusers')); ?>">Search User</a></li> -->
                        <?php if(Auth::user()->roleid == 1 OR Auth::user()->roleid == 5): ?>
                         <li >
                            <a href="#"><?php echo app('translator')->get('System Admin'); ?> <span class="fa arrow"></span></a>
                        ...
                        <?php if(Auth::user()->roleid == 1 OR Auth::user()->roleid == 2 OR Auth::user()->roleid == 5): ?>
                         <li >
                            <a href="#"><?php echo app('translator')->get('Students'); ?> <span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level collapse" style="">
                ...
                <li>
                    <a href="#"><i class="fa fa-print"></i> <span class="nav-label"><?php echo app('translator')->get('Financials'); ?></span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <?php if(Auth::user()->roleid == 1): ?>
                        <li><a href="<?php echo e(url('manageusers')); ?>"><?php echo app('translator')->get('Students Statements'); ?></a></li>
                         ...
                         <?php if(Auth::user()->roleid == 3): ?>
                           ...
                           <li><a href="<?php echo e(url('studentstatement')); ?>/<?php echo e(Auth::user()->id); ?>"><?php echo app('translator')->get('View Fee Statement'); ?></a></li>
                           <?php endif; ?>
                    </ul>
                </li>
                <?php endif; ?>
                <?php if(Auth::user()->roleid == 1 OR Auth::user()->roleid == 5): ?>
                 ...
                 <li>
                    ...
                    <a href="#"><i class="fa fa-cog"></i> <span class="nav-label"><?php echo app('translator')->get('Settings'); ?> </span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                  ...
                  <?php if(Auth::user()->roleid == 3 OR Auth::user()->roleid ==2 OR Auth::user()->roleid ==1): ?>
                   <li>
                    <a href="<?php echo e(url('updateprofile')); ?>/<?php echo e(Auth::user()->id); ?>"><i class="fa fa-user"></i> <span class="nav-label"><?php echo app('translator')->get('My profile'); ?></span></a>
                </li>
         ...
         <?php if(Auth::check()): ?>
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li>
                    ...
                    <span class="m-r-sm text-muted welcome-message text-white"><?php echo app('translator')->get('View Enquiries'); ?> <i class="fa fa-headphones"></i></span>
                </a>
                </li>
                ...
                <li>
                    ...
                    <span class="m-r-sm text-muted welcome-message text-white"><?php echo app('translator')->get('Enquiry Desk'); ?> <i class="fa fa-headphones"></i></span>
                </a>
                </li>
              ...
              <li class="dropdown">
                    <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                       <?php echo app('translator')->get('Notifications'); ?>  <i class="fa fa-bell"></i>   <span class="label label-warning" id="notcount"></span>
                    </a>
           ...
           <li class="dropdown">
                ...
                <li>
                    <span class="m-r-sm text-muted welcome-message text-white"><?php echo app('translator')->get('Welcome'); ?>: <?php echo e(Auth::user()->name); ?></span>
                </li>

                <li>
                    <a href="<?php echo e(route('logout')); ?>" class="text-white" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                        <i class="fa fa-sign-out text-white"></i><span class="text-white"> <?php echo app('translator')->get('Log out'); ?> </span>
                    </a>
